...
| 2 | O que é uma LLM | 🧠 |
| 3 | A Virada de 2025 | 🔄 |
| 4 | Agentes e Harness | ⚙️ |
| 5 | Dicionário de Conceitos | 📖 |
| 6 | Modelos de Fronteira | 🏆 |
| 7 | Comparativo de Ferramentas | ⚖️ |
...
| Parâmetros | ⚖️ Parâmetros | Os "pesos" aprendidos. Mais parâmetros ≠ modelo melhor. |
| Contexto | 🪟 Janela de Contexto | Quanto a IA "enxerga" de uma vez. Maior = lê mais código. |
| Temperatura | 🌡️ Temperatura | Controla criatividade. Baixa = mais preciso para código. |
...
- Conclusão: Badge terracota `"⚠️ Retornos Decrescentes"`
...
│  ┌───────────────────────────────┐  │
│  │  ⚙️ HARNESS                   │  │  ← Clicar lista os 5 componentes
│  │  ┌─────────────────────────┐  │  │
...
|---|---|---|
| LLM | Modelos | 🧠 |
| Harness | Arquitetura | ⚙️ |
| Agente de IA | Arquitetura | 🤖 |
| MCP | Protocolos | 🔌 |
| RAG | Arquitetura | 🧵 |
| Banco Vetorial | Arquitetura | 🗄️ |
...
│ GPT-4.5         │ ⚠️ Aposentando  │ Fim: 27/Jun/2026         │
│ o3              │ ⚠️ Aposentando  │ Fim: 26/Ago/2026         │
└─────────────────┴─────────────────┴──────────────────────────┘
```

**Badge de Status:**
- ✅ Verde → Ativo
- ⚠️ Âmbar → Aposentando em breve
...
- Modelo principal: Gemini 3.5 Flash | Contexto: 2M tokens

**3 Cards de Interface (lado a lado):**

| CLI | APP (2.0) | IDE |
|---|---|---|
| ⌨️ Terminal em Go | 🖥️ Desktop Standalone | 🛠️ VS Code Fork |
...
- Modelos: Opus / Sonnet / Haiku / Fable | Contexto: até 1M tokens

**2 Cards de Interface:**

| CLI | APP (Desktop) |
|---|---|
| ⌨️ `npm install -g claude-code` | 🖥️ Gestão de sessões |
| Modos: safe → autonomous | Visualização de artefatos |
| Comandos `/model`, `/usage` | Review de alterações |

**⚠️ Card de Mudança Importante (15/Jun/2026):**
```
...
|---|---|---|---|---|---|
| Interfaces | CLI+APP+IDE | CLI+APP | CLI+APP | IDE | APP |
| Modelos | Multi | Claude | GPT | Multi | Multi |
| Contexto máx. | 2M tokens | 1M tokens | ~200K | Variável | Variável |
| Multi-Agente | ✅ Nativo | ⚠️ Limitado | ⚠️ Básico | ❌ | ❌ |
| Estabilidade | ✅ | ⚠️ | ⚠️ | ✅ | ✅ |
...
│              │  │              │  │              │
│ Plus  $20    │  │ Pro    $20   │  │ AI Pro  $19  │
│ Pro  $100    │  │ Max5x  $100  │  │ Ultra   $99  │
│ Pro  $200    │  │ Max20x $200  │  │ Ultra+ $199  │
└──────────────┘  └──────────────┘  └──────────────┘
```
...
| Devin AI | $20/mês | $80 + $40/dev | ✅ Normal |
...
- **⚠️ Atenção:** Card âmbar com limitação relevante (se houver)

**Conteúdo dos 6 perfis:**

1. **Gerente** → Codex APP / $20 / "Sem terminal"
2. **Dev Sênior** → JetBrains AI + Claude Code CLI / $100 / "Dois ambientes"
3. **Dev Front-end** → Antigravity IDE / $20 / "Fork VS Code"
4. **Dev Back-end** → Plugin Claude Code + CLI / $20 / "Community sem AI nativo"
5. **Full-stack 1** → Claude Code CLI / $20 / "NetBeans sem suporte"
6. **Full-stack 2** → Claude Code CLI / $20 / "NetBeans sem suporte"

---

### SLIDE 16 — Mapa de Custos da Equipe
**Tipo:** Visualização de custo total com breakdown
**Layout:** Gráfico de barras horizontal + total no rodapé

**Barras por membro:**
```
Gerente        ████░░░░░░  $20/mês
Dev Sênior     ████████████ $100/mês  ← destaque diferente
Dev Front-end  ████░░░░░░  $20/mês
Dev Back-end   ████░░░░░░  $20/mês
Full-stack 1   ████░░░░░░  $20/mês
Full-stack 2   ████░░░░░░  $20/mês
               ─────────────────────
...
**Cards de contexto abaixo das barras:**
- Card verde: "Equivale a 1 hora de consultoria especializada"
- Card azul: "Ferramenta profissional para todos os 6 membros"
- Card âmbar: "O Sênior consome 50% do budget — justificado pela amplitude de linguagens"
